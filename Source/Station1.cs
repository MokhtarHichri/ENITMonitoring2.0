...
Ceci est le code source de l'interface de supervision de la station 1.
...
namespace Testing_Value_8Bit
{
    ...
    public partial class Station1 : Form
    {
        ...
        //Actualisation de l'affichage (Redondante car nous utilisons un subscriber)
        ...
        //Interface de supervision générale
        ...
        //Ecriture des valeurs des sorties modifées par le SwitchArray
